...
void threeButtonMenu(char *leftButtonText, char *middleButtonText, char *rightButtonText);


void twoButtonMenu(char *leftButtonText, char *rightButtonText);

void threeButtonText(char *leftButtonText, char *middleButtonText, char *rightButtonText);
